    ...
    <div class='header'>
        <div class="w1200">
            <el-row class="wrapper">
                <el-col :span="4">
                    <router-link to="/" class="logo"><img src="../../assets/img/logo.png" style="width: 100px;height: 60px;" alt=""></router-link>
                </el-col>
                <el-col :span="12">
                    <ul class="nav">
                        <li 
                            ...
                            @click="selectMenu(item.path)"><span>{{item.name}}</span>
                        </li>
                    </ul>
                </el-col>
                <el-col :span="6">
                            ...
                            <template>
                                <div class="hot-search" v-if="!keyVal">
                                    ...
                                    <div class="hot-search-list">
                                        <div class="hot-item" v-for="(item, index) in searchHot" :key="index" @click=jumpSearch(item)>
                ...
                <el-col :span="2" :class="isLogin ? 'user-avatar' : 'login'">
                    <div class="logined" v-if="isLogin">
                        <el-dropdown placement="bottom" @command="userMenuHandler">
                            ...
                            <template #dropdown>
                            <el-dropdown-menu>
                                <el-dropdown-item command="home"><router-link :to="{ name: 'My' }"> <i class="iconfont icon-home"></i>我的主页</router-link></el-dropdown-item>
    ...
    methods: {
        ...
        jumpPage (item, type) {
            ...
            switch (type) {
                ...
                break
                case 'artists':
                    this.$router.push({ path: '/artist/singer', query: { id: item.id } })
                break
                case 'albums':
        ...
        async getSearchSuggest () {
            const { data: res } = await this.$http.searchSuggest({ keywords: this.keyVal })
